...
CREATE TABLE censo_escolar_2020_escolas(
	...
	in_material_ped_multimidia  CHAR(1),
	in_material_ped_infantil  CHAR(1),
	in_material_ped_cientifico  CHAR(1),
	in_material_ped_difusao  CHAR(1),
	in_material_ped_musical  CHAR(1),
	in_material_ped_jogos  CHAR(1),
	in_material_ped_artisticas  CHAR(1),
	in_material_ped_desportiva  CHAR(1),
	in_material_ped_indigena  CHAR(1),
	in_material_ped_etnico  CHAR(1),
	in_material_ped_campo  CHAR(1),
	in_material_ped_nenhum  CHAR(1),
	...
	in_orgao_ass_pais  CHAR(1),
	in_orgao_ass_pais_mestres  CHAR(1),
	in_orgao_conselho_escolar  CHAR(1),
	in_orgao_gremio_estudantil  CHAR(1),
	in_orgao_outros  CHAR(1),
	in_orgao_nenhum  CHAR(1),

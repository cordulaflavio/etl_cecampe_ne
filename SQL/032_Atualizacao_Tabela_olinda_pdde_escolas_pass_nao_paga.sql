-------------------------------------------------------------------------
-- FKey de olinda_pdde_escolas_pass_nao_paga ON censo_escolar_2020_escolas
-------------------------------------------------------------------------

select count(*) from olinda_pdde_escolas_pass_nao_paga
select * from olinda_pdde_escolas_pass_nao_paga limit 100

ALTER TABLE olinda_pdde_escolas_pass_nao_paga 
ADD COLUMN co_escola_censo_2020 INT; 

UPDATE olinda_pdde_escolas_pass_nao_paga
SET co_escola_censo_2020 = co_escola
WHERE co_escola IN (SELECT distinct pdde.co_escola
					FROM olinda_pdde_escolas_pass_nao_paga pdde
...
-------------------------------------------------------------------------
-- FKey de olinda_pdde_escolas_pass_nao_paga ON censo_escolar_2019_escolas
-------------------------------------------------------------------------
...
-------------------------------------------------------------------------
-- FKey de olinda_pdde_escolas_pass_nao_paga ON censo_escolar_2018_escolas
-------------------------------------------------------------------------
...
-------------------------------------------------------------------------
-- FKey de olinda_pdde_escolas_pass_nao_paga ON censo_escolar_2017_escolas
-------------------------------------------------------------------------
...
-------------------------------------------------------------------------
-- FKey de olinda_pdde_escolas_pass_nao_paga ON censo_escolar_2016_escolas
-------------------------------------------------------------------------
...
-------------------------------------------------------------------------
-- FKey de olinda_pdde_escolas_pass_nao_paga ON ibge_relatorio_dtb_brasil_municipio
-------------------------------------------------------------------------
...
-- Regiao
-------------------------------------------------------------------------
-- Adicionar regiao no script pandas data_wrangling_PDDE_Escolas_Passiveis_Atendimento_NAO_PAGAS.ipynb
ALTER TABLE  olinda_pdde_escolas_pass_nao_paga
